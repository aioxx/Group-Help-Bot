...
";
    ...
    file_put_contents("data/$chat_id/rules.txt", "‼️ There are no rules here 🤦‍♂ Please type /setrules to set rules 🅿️!");
    bot('sendmessage', [
                'chat_id' => $chat_id,
                'text' =>"
The group has been activated 🤖  The English language was tested 🇺🇸❗️ ",
...
 By touching the keyboard ✋🏻",
   ...
   'reply_markup'=>json_encode([
      ...
      [
  	['text'=>"Delete list🗑",'callback_data'=>"delllhmss"]
	  ],
   [
...
if($data == "delllhmss"){bot('deleteMessage',['chat_id'=>$chat_id,'message_id'=>$message_id,]);bot('sendmessage',['chat_id'=>$chat_id,'message_id'=>$message_id,'text'=>"✬ The list has been deleted successfully 
",
'reply_to_message_id'=>$message->message_id,]);}
