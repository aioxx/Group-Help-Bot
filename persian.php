...
";
    ...
    file_put_contents("data/$chat_id/rules.txt", "‼️ اینجا هیچ قانونی وجود ندارد 🤦‍♂ لطفاً /setrules را برای تنظیم قوانین تایپ کنید 🅿️!");
    bot('sendmessage', [
                'chat_id' => $chat_id,
                'text' =>"
گروه فعال شد 🤖
...
از طریق کیبورد شیشه ای ✋🏻",
   ...
   'reply_markup'=>json_encode([
  	...
  	['text'=>"تنظیمات زبان 🗣",'callback_data'=>"settingslang"]
 	  ...
 	  [
  	['text'=>"حذف لیست🗑",'callback_data'=>"delllhmsss"]
	  ],
   [
...
if($data == "delllhmsss"){bot('deleteMessage',['chat_id'=>$chat_id,'message_id'=>$message_id,]);bot('sendmessage',['chat_id'=>$chat_id,'message_id'=>$message_id,'text'=>"✬ لیست با موفقیت حذف شد 
",
'reply_to_message_id'=>$message->message_id,]);}
